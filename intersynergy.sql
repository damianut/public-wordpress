...
--
-- Host: localhost
-- Czas generowania: 26 Lut 2020, 16:30
...
-- Procedury
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `current_ai_wp_posts` (OUT `current_ai` BIGINT)  SQL SECURITY INVOKER
BEGIN
SELECT AUTO_INCREMENT INTO current_ai FROM `information_schema`.`TABLES` AS `t1`
WHERE `t1`.TABLE_SCHEMA = "intersynergy" AND
`t1`.TABLE_NAME = "wp_posts";
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `current_post_id` (OUT `curr_id` BIGINT)  SQL SECURITY INVOKER
BEGIN
SELECT MAX(ID) INTO curr_id FROM wp_posts;
SET curr_id = IFNULL(curr_id, 0);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `incremented_id` (OUT `new_id` BIGINT)  SQL SECURITY INVOKER
BEGIN
SELECT MAX(ID) INTO new_id FROM wp_posts;
SET new_id = IFNULL(new_id, 0) + 1;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `truncate_wp_posts` ()  SQL SECURITY INVOKER
BEGIN
CALL current_post_id(@a);
IF @a = 0 THEN TRUNCATE TABLE `wp_posts`;
END IF;
END$$
...
-- Funkcje
--
CREATE DEFINER=`root`@`localhost` FUNCTION `get_current_post_id` () RETURNS BIGINT DETERMINISTIC SQL SECURITY INVOKER
BEGIN
CALL current_post_id(@a);
RETURN @a;
END$$

CREATE DEFINER=`root`@`localhost` FUNCTION `get_new_id` () RETURNS BIGINT DETERMINISTIC SQL SECURITY INVOKER
BEGIN
CALL incremented_id(@a);
RETURN @a;
END$$

CREATE DEFINER=`root`@`localhost` FUNCTION `truncate_wp_posts_f` () RETURNS BIGINT DETERMINISTIC SQL SECURITY INVOKER
BEGIN
CALL truncate_wp_posts;
RETURN 0;
END$$
...
CREATE TABLE `user` (
  ...
  `pesel` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `person_description` varchar(3000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interests` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `skills` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `experience` varchar(5000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `birth_date` date DEFAULT NULL,
  `rating` int DEFAULT NULL,
  `cvfilename` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `registration_date` datetime NOT NULL,
  `entry_updating_date` datetime NOT NULL,
  `login_date` datetime DEFAULT NULL,
  `blocked_confirmation_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reset_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `logged_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'siteurl', 'http://192.168.0.26/wordpress', 'yes'),
(2, 'home', 'http://192.168.0.26/wordpress', 'yes'),
(3, 'blogname', 'CV Center', 'yes'),
(4, 'blogdescription', 'Card index with candidates and CVs.', 'yes'),
(5, 'users_can_register', '0', 'yes'),
(6, 'admin_email', 'damianas1999@gmail.com', 'yes'),
...
(33, 'active_plugins', 'a:1:{i:0;s:33:\"cpt-candidates/cpt-candidates.php\";}', 'yes'),
(34, 'category_base', '', 'yes'),
(35, 'ping_sites', 'http://rpc.pingomatic.com/', 'yes'),
(36, 'comment_max_links', '2', 'yes'),
(37, 'gmt_offset', '0', 'yes'),
(38, 'default_email_category', '1', 'yes'),
(39, 'recently_edited', 'a:2:{i:0;s:66:\"/var/www/html/wordpress/wp-content/themes/twentynineteen/style.css\";i:1;s:0:\"\";}', 'no'),
...
(93, 'admin_email_lifespan', '1597496534', 'yes'),
...
(102, 'sidebars_widgets', 'a:3:{s:19:\"wp_inactive_widgets\";a:10:{i:0;s:6:\"text-4\";i:1;s:6:\"text-5\";i:2;s:10:\"archives-2\";i:3;s:6:\"meta-2\";i:4;s:8:\"search-2\";i:5;s:6:\"text-2\";i:6;s:6:\"text-3\";i:7;s:12:\"categories-2\";i:8;s:14:\"recent-posts-2\";i:9;s:17:\"recent-comments-2\";}s:9:\"sidebar-1\";a:0:{}s:13:\"array_version\";i:3;}', 'yes'),
(103, 'cron', 'a:6:{i:1582725757;a:1:{s:34:\"wp_privacy_delete_old_export_files\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:6:\"hourly\";s:4:\"args\";a:0:{}s:8:\"interval\";i:3600;}}}i:1582725809;a:2:{s:19:\"wp_scheduled_delete\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}s:25:\"delete_expired_transients\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}i:1582725811;a:1:{s:30:\"wp_scheduled_auto_draft_delete\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}i:1582765357;a:3:{s:16:\"wp_version_check\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}s:17:\"wp_update_plugins\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}s:16:\"wp_update_themes\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1582808555;a:1:{s:32:\"recovery_mode_clean_expired_keys\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}s:7:\"version\";i:2;}', 'yes'),
...
(5, 6, '_customize_draft_post_name', 'the-new-umoma-opens-its-doors'),
(6, 6, '_customize_changeset_uuid', 'f0a26d9b-d559-4099-9ab5-3c13f6aa3570'),
(11, 9, '_customize_draft_post_name', 'blog'),
(12, 9, '_customize_changeset_uuid', 'f0a26d9b-d559-4099-9ab5-3c13f6aa3570'),
(13, 11, '_customize_draft_post_name', 'the-new-umoma-opens-its-doors'),
(14, 11, '_customize_changeset_uuid', 'ae92c3ab-0335-4fbe-a13f-f16cc81ea7b6'),
(15, 12, '_customize_draft_post_name', 'about'),
(16, 12, '_customize_changeset_uuid', 'ae92c3ab-0335-4fbe-a13f-f16cc81ea7b6'),
(17, 13, '_customize_draft_post_name', 'contact'),
(18, 13, '_customize_changeset_uuid', 'ae92c3ab-0335-4fbe-a13f-f16cc81ea7b6'),
(19, 14, '_customize_draft_post_name', 'blog'),
(20, 14, '_customize_changeset_uuid', 'ae92c3ab-0335-4fbe-a13f-f16cc81ea7b6'),
(21, 15, '_edit_lock', '1582033243:1'),
(22, 3, '_wp_trash_meta_status', 'draft'),
(23, 3, '_wp_trash_meta_time', '1582033485'),
(24, 3, '_wp_desired_post_slug', 'privacy-policy'),
(25, 2, '_wp_trash_meta_status', 'publish'),
(26, 2, '_wp_trash_meta_time', '1582033487'),
(27, 2, '_wp_desired_post_slug', 'sample-page'),
(33, 19, '_customize_changeset_uuid', '439fe75a-2b8e-4324-ad62-81dfb4be993c'),
(35, 20, '_customize_changeset_uuid', '439fe75a-2b8e-4324-ad62-81dfb4be993c'),
(37, 21, '_customize_changeset_uuid', '439fe75a-2b8e-4324-ad62-81dfb4be993c'),
(39, 22, '_customize_changeset_uuid', '439fe75a-2b8e-4324-ad62-81dfb4be993c'),
(40, 23, '_edit_lock', '1582034164:1'),
(41, 23, '_wp_trash_meta_status', 'publish'),
(42, 23, '_wp_trash_meta_time', '1582034077'),
(43, 28, '_wp_trash_meta_status', 'publish'),
(44, 28, '_wp_trash_meta_time', '1582034176'),
(45, 15, '_customize_restore_dismissed', '1'),
(46, 10, '_customize_restore_dismissed', '1'),
(48, 30, '_edit_lock', '1582035459:1'),
(49, 30, '_wp_page_template', ''),
(51, 33, '_edit_lock', '1582036068:1'),
(52, 29, '_customize_restore_dismissed', '1'),
(54, 34, '_customize_restore_dismissed', '1'),
(55, 35, '_edit_lock', '1582036964:1'),
(120, 35, '_wp_trash_meta_status', 'publish'),
(121, 35, '_wp_trash_meta_time', '1582036992'),
(122, 44, '_edit_lock', '1582052146:1'),
(131, 45, '_wp_trash_meta_status', 'publish'),
(132, 45, '_wp_trash_meta_time', '1582052370'),
(133, 48, '_edit_last', '1'),
(134, 48, '_edit_lock', '1582201961:1'),
(135, 50, '_edit_lock', '1582201876:1'),
(136, 51, '_edit_lock', '1582202010:1'),
(137, 52, '_edit_lock', '1582202016:1'),
(138, 53, '_edit_last', '1'),
(139, 53, '_edit_lock', '1582295590:1'),
(140, 53, 'Author', 'Typical Author'),
(141, 54, '_edit_last', '1'),
(142, 54, '_edit_lock', '1582295597:1'),
(143, 55, '_edit_lock', '1582298271:1'),
(145, 56, '_customize_changeset_uuid', 'f32de415-8974-4ab5-a449-d1cb9e79d3c0'),
(146, 57, '_menu_item_type', 'post_type'),
(147, 57, '_menu_item_menu_item_parent', '0'),
(148, 57, '_menu_item_object_id', '56'),
...
(2, 'Categorized', 'categorized', 0),
(3, 'Post', 'post', 0),
(4, 'Semi-categorized', 'sem-cat', 0),
(5, 'Semi-uncategorized', 'semi-uncat', 0),
(6, 'Knieje', 'knyj', 0),
...
(2, 2, 'category', '', 0, 1),
(3, 3, 'post_tag', '', 0, 1),
(4, 4, 'category', 'Semi category.', 2, 0),
(5, 5, 'category', 'Semi uncategory.', 1, 0),
(6, 6, 'category', 'Niech ryczy.', 0, 0),
(9, 9, 'nav_menu', '', 0, 1);
...
(16, 1, 'session_tokens', 'a:5:{s:64:\"35d135d25afa04257db67ccb8be7dce6cd4ceadd1e9cb4a35cf7449357063598\";a:4:{s:10:\"expiration\";i:1582713262;s:2:\"ip\";s:12:\"192.168.0.26\";s:2:\"ua\";s:105:\"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.116 Safari/537.36\";s:5:\"login\";i:1582540462;}s:64:\"61059cf803f5d245935a39988b6bbfe9451b274a13fa1a1a19b0cf344a85ee44\";a:4:{s:10:\"expiration\";i:1582717674;s:2:\"ip\";s:12:\"192.168.0.26\";s:2:\"ua\";s:105:\"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.116 Safari/537.36\";s:5:\"login\";i:1582544874;}s:64:\"02ade6bbd8325475fe8a35687cfe44b04b1dd94fc3dc9a3a06e26d89b5419989\";a:4:{s:10:\"expiration\";i:1582718843;s:2:\"ip\";s:12:\"192.168.0.26\";s:2:\"ua\";s:105:\"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.116 Safari/537.36\";s:5:\"login\";i:1582546043;}s:64:\"73ddfcc49ba4be9569624ba759512ad3222b1f9d18cf4890cb6b9c2ad19c91ee\";a:4:{s:10:\"expiration\";i:1582741011;s:2:\"ip\";s:12:\"192.168.0.26\";s:2:\"ua\";s:105:\"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.116 Safari/537.36\";s:5:\"login\";i:1582568211;}s:64:\"53a09e57ff3641b8e24f5d4106d52eeb01858624286ee265366eaee337537696\";a:4:{s:10:\"expiration\";i:1582822724;s:2:\"ip\";s:12:\"192.168.0.26\";s:2:\"ua\";s:105:\"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.116 Safari/537.36\";s:5:\"login\";i:1582649924;}}'),
...
(22, 1, 'wp_user-settings-time', '1582294082'),
...
(1, 'wordpress', '$P$BnQ1QWolBUUxbxE4EKpzK42T1ONhUB1', 'wordpress', 'damianas1999@gmail.com', '', '2020-02-17 13:02:29', '', 0, 'wordpress');
...
ALTER TABLE `user`
  ...
  ADD UNIQUE KEY `UNIQ_8D93D6499051FF0F` (`blocked_confirmation_token`),
  ADD UNIQUE KEY `UNIQ_8D93D649D7C8DC19` (`reset_token`),
  ADD UNIQUE KEY `UNIQ_8D93D6491DA75C51` (`logged_token`);
...
--
ALTER TABLE `wp_options`
  MODIFY `option_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=374;

--
-- AUTO_INCREMENT dla tabeli `wp_postmeta`
--
ALTER TABLE `wp_postmeta`
  MODIFY `meta_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=270;
